...
public class ExcerciePassewordValidator {
    ...
    public ExcerciePassewordValidator(String username, String currentPassword) {
    ...
    public static ExcerciePassewordValidator login(){
        ...
        return new ExcerciePassewordValidator(username, password);
    }
